...
<div class="wrap">
            ...
            <?php foreach ($statti as $row) : ?>
                ...
                <table class='table' width='780' border='0' cellspacing='0' cellpadding='0'>
                    <tr>
                        <td class='td_top'>
                            <h5>
                                <a title='<?php echo $row['title']; ?>' href='view_text.php?id=<?php echo $row['id']; ?>'><?php echo $row['title']; ?></a>
                            </h5>
    ...
    <div class='footer'>
        <?php echo "<p style='text-align:right;font_size:5px; color:white;margin:10px;'>" . $site_name . "</p>"; ?>
    </div>
</div>
</body>
</html>